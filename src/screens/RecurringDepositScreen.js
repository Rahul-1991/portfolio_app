...
const RecurringDepositScreen = ({ route, navigation }) => {
  ...
  const saveTransaction = async () => {
    ...
    try {
      ...
      // For RD, multiply monthly amount by duration for total investment
      ...
      <Portal>
        ...
        >
          <View style={styles.dialogHeader}>
            <Dialog.Title style={styles.dialogTitle}>New Recurring Deposit</Dialog.Title>
